...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebAppPortMapping) DeepCopyInto(out *WebAppPortMapping) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebAppPortMapping.
func (in *WebAppPortMapping) DeepCopy() *WebAppPortMapping {
	if in == nil {
		return nil
	}
	out := new(WebAppPortMapping)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WebAppSpec) DeepCopyInto(out *WebAppSpec) {
	*out = *in
	if in.Ports != nil {
		...
		*out = make([]WebAppPortMapping, len(*in))
		copy(*out, *in)
	}
}
